...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden bg-[#030303]">
      ...
      <AmbientGlow size="md" color="indigo" opacity={0.15} className="-bottom-20 -right-20" />
          ...
          <SpatialPanel glow className="p-8 md:p-10 border-zinc-800/80 bg-zinc-950/40 backdrop-blur-2xl shadow-[0_30px_70px_rgba(0,0,0,0.8)] relative">
            ...
            <div className="mb-8">
              ...
              <p className="text-zinc-500 text-xs mt-1.5 leading-relaxed font-sans">
                Initialize a free intelligence profile to analyze your resume and match vacancies.
              </p>
            </div>
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-center px-16 bg-zinc-950/30 border-l border-zinc-900 relative overflow-hidden">
        <AmbientGlow size="md" color="indigo" opacity={0.1} className="top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
        <IntelligencePreview />
      </div>
    </div>
  );
